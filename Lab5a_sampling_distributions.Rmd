...
We can see that as the sample size increase, the mean gets closer to the population mean and the standard error decreases. We also see the shape of the sampling distributions go from right-skewed, to normally distributed, to almost no tails, where the variation from the mean is low. 
