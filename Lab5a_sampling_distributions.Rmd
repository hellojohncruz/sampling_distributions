...
The comparison bar graph shows that both the population and sampling distributions proportions does not have drastic differences between each other. However, we have not verified if this sample is statistically representative of the population. 
